      ...
      <div className="fluid container">
        ...
        <p className="text-center">
          ...
          <b>
            Visit the
            {' '}
            <a href="https://docs.geolosys.com" rel="noopener noreferrer" target="_blank">ReadTheDocs page</a>
            {' '}
            for
        ...
        <p>
          ...
          worry, because I&apos;ve recently developed a tool just for that:
        </p>
        ...
        <p>
          In lieu of the overwhelming size and amount of configuration that can be done to Geolosys,
          I have developed a web tool which adds a graphical interface to the configuration process.
          You can register for an account to save your configurations for later download, and it
          supports 1.12 and 1.14/1.15+ JSON versions.
        </p>
      </div>
